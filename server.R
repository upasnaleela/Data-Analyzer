...
shinyServer(function(input, output) {
  ...
  pos.words = scan('D:/STUDY/BE/FINAL YEAR PROJECT/7TH SEM/IMPLEMENTATION/DATA ANALYZER/TWITTER/TWITTER ANALYSIS/positive-words.txt', what='character', comment.char=';')
  neg.words = scan('D:/STUDY/BE/FINAL YEAR PROJECT/7TH SEM/IMPLEMENTATION/DATA ANALYZER/TWITTER/TWITTER ANALYSIS/negative-words.txt', what='character', comment.char=';')
